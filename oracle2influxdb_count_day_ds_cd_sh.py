...
and exists (select '1' from CPT_CST_REQUEST_LOG@ZHENGXIN cz where cz.created_at>=to_date(to_char(sysdate-1,'yyyymmdd')||'00:00:00','yyyymmdd hh24:mi:ss')
...
for row in rows:
        ...
        json_body=[{"measurement":"count_day_ds","tags":{"ds_day":day_date},"fields":{"day":day_date,"ds_name":"成都到上海","count":row[1]}}]
